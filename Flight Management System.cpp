...
const char l_destination[5][20]={"DELHI","AHMEDABAD","SURAT","MUMBAI","MANGALORE"};	//local Destination
const char i_destination[11][20]={"LONDON","BERLIN","DUBAI","RIYADH","BEIJING","PARIS","CANBERRA","TOKYO","WASHINGTON","NEWYORK","TORONTO" }; //International Destination
...
class Manage
{
	...
	public:
		...
		{	
			...
			ifstream file("flight.txt",ios::app);
			if(file.is_open())
			{
